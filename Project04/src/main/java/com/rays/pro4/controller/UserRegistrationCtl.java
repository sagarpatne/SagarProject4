...
public class UserRegistrationCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("firstName"))) {
			...
			request.setAttribute("firstName", "First Name must be in alphabet only");
			pass = false;
		}
		...
		if (DataValidator.isNull(request.getParameter("lastName"))) {
			...
			request.setAttribute("lastName", "Last Name must be in alphabet only");
			pass = false;
		}
		...
		if (!request.getParameter("password").equals(request.getParameter("confirmPassword"))
			...
			request.setAttribute("confirmPassword",
					PropertyReader.getValue("error.require", "Password and Confirm Password Must Be Same"));
			pass = false;
		}
